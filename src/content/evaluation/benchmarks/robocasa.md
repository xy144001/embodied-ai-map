...
- **两套本体不可互换**：GR-1 为 29 维关节级动作（双臂 + 灵巧手 + 腰部），365 默认 PandaOmron 为 12D；把 GR1 checkpoint 放进 PandaOmron 的 RoboCasa365 是无效组合。逐维拆解见[本体与控制量图谱](../robot-action-audit/)，部署细节见[方法部署记录](../../reproductions/policy-deployment-records/)。
